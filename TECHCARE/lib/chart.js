import { legendPlugin } from "../scripts/legend.js";

/**
 * Creates and renders a line chart showing blood pressure data for the last 6 months.
 * 
 * @param {Array} data - Array of data objects containing blood pressure information.
 * @param {string} container - CSS selector for the HTML element where the chart will be rendered.
 */
